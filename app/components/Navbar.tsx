...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Drawer Overlay — full screen, outside header */}
      <div
        className={`fixed inset-0 bg-white/95 backdrop-blur-xl flex flex-col items-center justify-center gap-8 z-50 md:hidden transition-all duration-300 ease-in-out ${isOpen
